...
public class Exp21 {
	...
	private static String path = "C:\\Users\\LI\\Desktop\\CPNs3\\FCFS\\DVFS\\";
	...
	public static void main(String[] args) {
		...
		nList.add("FCFS");nList.add("DVFS1");nList.add("DVFS2");nList.add("DVFS3");
...
//			System.out.println("EDP");
			for(int j=0; j<nList.size(); j++) {
				...
				if(j==0) {
					...
					energy = Calculate.getDVFSEnergy(thresh[i],filePath);
				}
...
//				System.out.println(df.format(fixrate) + "f");
