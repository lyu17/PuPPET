...
public class E13 {
	...
	private static String path = "C:\\Users\\LI\\Desktop\\CPNs3\\WFP\\13\\";
...
//	private static int[][] thresh40 = {{692,989},  {680,971},  {826,1179}, {780,1114}};
	...
	public static void main(String[] args) {
		...
		nList.add("05");nList.add("10");nList.add("15");nList.add("20");
...
//			System.out.println("EDP");
			for(int j=0; j<nList.size(); j++) {
				...
				if(j==0) {
					energy = Calculate.getDVFSEnergy(thresh[i],filePath) / fixrate[i];
				}
				else if(j==1) {
					energy = Calculate.getDVFSEnergy(thresh[i],filePath) / fixrate[i];
				}
